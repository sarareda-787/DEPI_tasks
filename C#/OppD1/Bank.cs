...
namespace OppD1
{
    public class Bank
    {
        ...
        public Bank (string fullname, int accountnumber, string nationalID, string phonenumber, string address, double balance )
        {
            FullName = fullname;
        ...
        public Bank(string nationalID, double balance)
        {
            NationalID = nationalID;
            Balance = balance;

        }
        public Bank(string fullname, int accountnumber, string nationalID, string phonenumber, string address) 
            :this(fullname, accountnumber, nationalID, phonenumber,address,0) 
        { 
        }
        public virtual double CalculateInterset() => 0;
        public virtual  void ShowAccountDetails()
        {
            Console.WriteLine("===== Account Details =====");
            Console.WriteLine($"Bank Code     : {Bankcode}");
            Console.WriteLine($"Account No.   : {ِAccountNumber}");
